...
class Product(models.Model):
    ...
    product_sac = models.CharField(max_length=50, null=True, blank=True)
    service_number = models.CharField(max_length=200, blank=True, null=True)
...
class InventoryLog(models.Model):
    ...
    def __str__(self):
        return "product"+ " | " + str(self.change) + " | " + self.description + " | " + str(self.date)
